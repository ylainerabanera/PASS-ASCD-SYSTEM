                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="table-actions">
                                        <a class="btn btn-sm btn-edit" href="{{ route('schedules.edit', $schedule) }}"><i class="bi bi-pencil-square me-1"></i>Edit</a>
                                        <form action="{{ route('schedules.destroy', $schedule) }}" method="POST" class="d-inline">
                                            @csrf
                                            @method('DELETE')
                                            <button class="btn btn-sm btn-delete" onclick="return confirm('Delete this schedule?')"><i class="bi bi-trash me-1"></i>Delete</button>
                                        </form>
                                    </div>
                                </td>
                            </tr>
